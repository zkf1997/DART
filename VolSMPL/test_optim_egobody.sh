...
batch_size=1  # dummy value fixed to 1
num_seq=4  # number of sequences to generate iteratively
optim_lr=0.05
optim_steps=100
optim_unit_grad=1
optim_anneal_lr=1
...
load_cache=0
interaction_cfg='./VolSMPL/cfg/cnb_dlab_0215.json'
#interaction_cfg='./VolSMPL/cfg/cab_e.json'
coap_max_frames=16
#loss_type='coap'
loss_type='volsmpl'
volsmpl_gender='male'
#volsmpl_gender='neutral' # the original experiments are run using neutral model
