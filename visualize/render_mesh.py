...
if __name__ == '__main__':
    ...
    out_smpl_path = params.input_path.replace('.mp4', '_smpl_params.npz')
    ...
    print('Saving SMPL params to [{}]'.format(os.path.abspath(out_smpl_path)))
    npy2obj.save_npz(out_smpl_path)
